...
def parse_args():
    ...
    parser.add_argument('--max_vis', type=int, help='Maximum number of images/visualizations (only works on adequately large datasets)')
    ...
    parser.add_argument('--batch-size-test', type=int, help='The batch size to use during evaluation')
    
    parser.add_argument('--learning_rate', type=float, help='Optimizer learning rate')
    parser.add_argument('--epochs', type=int, help='Epoch amount')
